  ...
  return (
    <main className="opc-office">
      ...
      <div className="opc-stage">
        ...
        <section className={`opc-floor opc-time-${officeTime}`} style={OFFICE_SHADERS[officeTime].style as CSSProperties}>
