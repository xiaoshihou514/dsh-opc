...
export function OfficePanel({
  ...
  const selected =
    sessions.find((session) => session.id === selectedId) ?? visibleSessions[0];
  useEffect(() => {
        ...
        <aside className="opc-comms">
          ...
          >
            <textarea
              ...
              disabled={selected === undefined || sending}
              placeholder={
                selected === undefined
                  ? "请先选择角色"
            ...
            <div className="opc-orderRow">
              ...
              <button
                ...
                type="submit"
                disabled={
                  selected === undefined || draft.trim() === "" || sending
                }
              >
                {sending ? "发送中…" : "下达指令"}
              </button>
